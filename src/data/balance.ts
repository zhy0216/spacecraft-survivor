 ...
 * 应当在这个时间内击杀 Boss。取窗口中点 129,单测断言落 [115, 135] 内。
 * 2026-08-16 难度上调:82.5 → 124(+50%,Boss 血量同步 +50%,配 Z 字冲刺的走廊压力)。
 * 2026-08-16 再调:124 → 129(Boss 血量 3853 → ≈3990:冲刺轨迹加长到跨屏、冲刺中
 * 弹射小怪,反打压力上抬,血量随之回抬,闸门配装的 TTK 仍钉在同一窗口内)。
 * 之后调难度时这是第二个旋钮:抬它 = 闸门更松,压它 = 更紧。
 */
export const GATE_TTK_TARGET = 129;
/** TTK 窗口下界(秒):目标值的最小合法档 */
export const GATE_TTK_MIN = 115;
/** TTK 窗口上界(秒):目标值的最大合法档 */
export const GATE_TTK_MAX = 135;
